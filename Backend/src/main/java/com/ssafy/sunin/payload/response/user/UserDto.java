...
public class UserDto {
    ...
    @Builder
    public UserDto(Long userSeq, String userId, String username, String password, String userNickname, String email, String emailVerifiedYn, String profileImageUrl, ProviderType providerType, RoleType roleType, LocalDateTime createdAt, LocalDateTime modifiedAt, String introduction, String address, String phoneNumber, int suninDays) {
