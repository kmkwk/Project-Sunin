...
export default function Alarm(){
  ...
  //       // 해당 각 유저 유일값으로 열어두고 있음
  //       console.log(token);
  //       stompClient.subscribe(`/sub/`+token, (res: any) => {
  ...
  // function send() {
  //   // 해당 유저의 유일값으로 보냄
  //   stompClient.send(`/send/iUk9MRV9VU0VSIiwiZXhwIjoxNjQ0OTEyNzI2fQ.BmnY-L3ilYleQgIzezgdcowwq8mDN7FmTKj5AEaldVQ`+3+`/`+messages)
  // }
